    ...
    <div className="w-full max-w-5xl mx-auto px-4 sm:px-10 py-10 relative z-10">
      ...
      <div className="mb-12 flex flex-col items-center md:items-start">
        ...
        <div className="text-center md:text-left w-full">
          <h1 className="text-4xl font-black text-slate-900 dark:text-white mb-4 tracking-widest drop-shadow-sm uppercase">安全圈友链</h1>
          <p className="text-slate-600 dark:text-slate-400 font-serif">网络安全圈的大佬们，欢迎交换友链！</p>
        </div>
      </div>
